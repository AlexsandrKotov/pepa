	...
	return func(c *gin.Context) {
		...
		if oidc.ClientSecret != "" {
			if len(oidc.ClientSecret) > 4 {
				...
				maskedSecret = "••••••••" // #nosec //nolint:gosec // G101: mask string, not a credential
			}
		}
		c.JSON(http.StatusOK, gin.H{
	...
	return func(c *gin.Context) {
		...
		if ldap.BindPassword != "" {
			if len(ldap.BindPassword) > 4 {
				...
				maskedPassword = "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" // #nosec //nolint:gosec // G101: mask string, not a credential
			}
		}
		maskedCACert := ""
		if ldap.CACertificate != "" {
			maskedCACert = "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" // #nosec //nolint:gosec // G101: mask string, not a credential
		}
		c.JSON(http.StatusOK, gin.H{
