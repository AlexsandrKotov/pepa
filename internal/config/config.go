...
func DefaultConfig() *Config {
	return &Config{
		...
		Auth: AuthConfig{ // #nosec // G101: struct contains dev default JWT secret; Validate() warns if not overridden
			JWTSecret:       "dev-jwt-secret-change-in-production", // #nosec // G101: dev default; Validate() warns if not overridden
...
//
// #nosec // G101: these are sentinel values for dev-mode warnings, not real credentials
