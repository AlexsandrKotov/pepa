...
func TestDatabaseConfig_ConnectionString(t *testing.T) {
	...
	want := "postgres://admin:secret@db.example.com:5432/mydb?sslmode=require" // #nosec //nolint:gosec // G101: test connection string
	if got != want {
...
func TestDatabaseConfig_ConnectionString_Disable(t *testing.T) {
	...
	got := d.ConnectionString()
	if got != "postgres://user:pass@localhost:5432/test?sslmode=disable" { // #nosec //nolint:gosec // G101: test connection string
