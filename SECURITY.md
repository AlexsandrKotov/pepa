...
Send an email to **security@pepa.dev** with:

> **Note**: If `security@pepa.dev` is not yet configured, use [GitHub Private Security Reporting](https://github.com/AlexsandrKotov/pepa/security/advisories/new) instead.
...
- Email fallback: **security@pepa.dev** (if configured)
