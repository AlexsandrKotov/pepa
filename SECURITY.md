...
1. Go to the [Security Advisories page](https://github.com/your-username/pepa/security/advisories/new)
...
> **Note**: If `security@github.com` is not yet configured, use [GitHub Private Security Reporting](https://github.com/your-username/pepa/security/advisories/new) instead.
...
- [GitHub Security Advisories](https://github.com/your-username/pepa/security/advisories)
- Release notes for patch versions
- Community Slack (post-launch)

## Contact

- Security reports: **[GitHub Security Advisory](https://github.com/your-username/pepa/security/advisories/new)** (preferred)
