...
export const PROFILE_CONFIGS: Record<DashboardProfile, DashboardProfileConfig> = {
  overview: {
    ...
    widgets: ['deployment-health', 'cluster-health', 'services-catalog', 'pipeline-activity', 'my-workspace', 'platform-health'],
  ...
  operations: {
    ...
    widgets: ['deployment-health', 'cluster-health', 'pipeline-activity', 'environment-overview', 'gitops-status', 'my-workspace', 'platform-health'],
  ...
  development: {
    ...
    widgets: ['services-catalog', 'pipeline-activity', 'deployment-health', 'environment-overview', 'my-workspace'],
  ...
  administration: {
    ...
    widgets: ['security-compliance', 'deployment-health', 'cluster-health', 'platform-health'],
