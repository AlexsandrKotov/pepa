          ...
          <div className="card">
            <div className="card-body space-y-4">
              ...
              <div className="relative overflow-hidden">
                <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--text-tertiary)] pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
